...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = "com.sampleproject.api")
@EnableTransactionManagement
@EnableJpaRepositories(basePackages = "com.sampleproject.api.Repository")
public class AppConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        emf.setPackagesToScan("com.sampleproject.api.Entity");
